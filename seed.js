...
(async() => {
    ...
    await Produit.create([{
        ...
        },
        {
            ...
            description: "Jean slim stretch, ajusté et confortable. Fabriqué avec un denim extensible pour une liberté de mouvement optimale et un look moderne.",
            marque: "FlexDenim",
            taille: "M",
            genre: "H",
            prix: 69.99,
        ...
        },
        {
            ...
            description: "Pantalon chino en twill léger et durable, idéal pour les tenues décontractées ou professionnelles. Coupe droite et polyvalente pour un style élégant.",
            marque: "ClassicChino",
            taille: "L",
            genre: "H",
            prix: 59.99,
        ...
        },
        {
            ...
            description: "Pantalon cargo robuste avec poches cargo et détails de renfort. Parfait pour les activités de plein air ou pour un look décontracté et fonctionnel.",
            marque: "OutdoorCargo",
            taille: "XL",
            genre: "H",
            prix: 79.99,
        ...
        },
        {
            ...
            description: "Pantalon de costume slim, élégant et moderne. Parfait pour les occasions formelles et professionnelles. Fabriqué avec un tissu de qualité pour un ajustement parfait.",
            marque: "SuitedStyle",
            taille: "M",
            genre: "H",
            prix: 89.99,
        ...
        },
        {
            ...
            description: "Pantalon de jogging en molleton doux et confortable, idéal pour les séances d'entraînement ou pour se détendre à la maison. Taille élastique et coupe décontractée.",
